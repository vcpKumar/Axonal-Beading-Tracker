...
*__This code is designed to overcome the subjectivity and reduce the human effort when analyzing large number of images of beaded axons.__* 
...
*__This code can also be applied to analyse diameters of ridge like structures (blood vessels, road networks, geographical features, etc).__* 
