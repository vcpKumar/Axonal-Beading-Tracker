...
# %% CROPPING
def cropping(im, imColor, mask, cropBox, h, w):
    """
    ...
    imColor : numpy.ndarray, uint8
        The color image to be cropped.
    ...
    imColorCrop = imColor[yCrop1:yCrop2, xCrop1:xCrop2, :]
    cropShape = np.shape(imCrop)
    cropBox = [yCrop1, yCrop2, xCrop1, xCrop2]

    return imCrop, imColorCrop, maskCrop, cropShape, cropBox
